...
const DetailsGroups = ({ route }) => {
  ...
  <View style={styles.modalOverlay}>
    <View style={styles.elegantModal}>
      <MaterialIcons name="help-outline" size={40} color="#944af5" style={{ marginBottom: 10 }} />
      <Text style={styles.elegantTitle}>Confirmar invitación</Text>
      <Text style={styles.elegantText}>
        ¿Estás seguro de que deseas invitar a {selected.length} usuario(s) a este parche?
      </Text>
      <View style={styles.elegantButtons}>
        <TouchableOpacity
          style={[styles.elegantButton, { backgroundColor: '#944af5' }]}
          onPress={() => {
            setShowConfirmModal(false);
            sendInvitations();
          }}>
          <Text style={styles.elegantButtonText}>Sí, invitar</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[styles.elegantButton, { backgroundColor: '#333' }]}
          onPress={() => setShowConfirmModal(false)}>
          <Text style={styles.elegantButtonText}>Cancelar</Text>
        </TouchableOpacity>
      </View>
    </View>
  </View>
